...
<html lang="en">
	<head>
		...
		<link href="<?php echo config_item('css'); ?>select2.css" rel="stylesheet">
		<link href="<?php echo config_item('css'); ?>select2.min.css" rel="stylesheet">
		<script src="<?php echo config_item('js'); ?>jquery.min.js"></script>
		<script src="<?php echo config_item('js'); ?>select2.full.min.js"></script>
		<script src="<?php echo config_item('js'); ?>select2.full.js"></script>
		<script src="<?php echo config_item('js'); ?>select2.js"></script>
