	...
	<div class="container-fluid">
		<div class="navbar-header">
			...
			<a class="navbar-brand" href="<?php echo site_url(); ?>">
				<img width="70" alt="<?php echo config_item('web_title'); ?>" src="<?php echo config_item('img'); ?>astro_boy.png">
			</a>
		</div>
		...
		<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
			<ul class="nav navbar-nav">
				...
				<li class="dropdown <?php if($controller == 'barang') { echo 'active'; } ?>">
					<a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><i class='fa fa-cube fa-fw'></i> Item Dan Toko/Resto <span class="caret"></span></a>
					<ul class="dropdown-menu">
						<li><a href="<?php echo site_url('barang'); ?>">Semua Item</a></li>
						<li role="separator" class="divider"></li>
						<li><a href="<?php echo site_url('barang/list-kategori'); ?>">List Kategori</a></li>
						<li><a href="<?php echo site_url('barang/list-merek'); ?>">List Resto/Toko</a></li>
					</ul>
				</li>

				<li class="dropdown <?php if($controller == 'perusahaan') { echo 'active'; } ?>">
					<a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><i class='fa fa-building fa-fw'></i> Perusahaan <span class="caret"></span></a>
					<ul class="dropdown-menu">
						<li><a href="<?php echo site_url('perusahaan'); ?>">Semua Perusahaan</a></li>
						<li role="separator" class="divider"></li>
