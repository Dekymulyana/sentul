...
<div class="container">
	<div class="panel panel-default">
		<div class="panel-body">
			<h5><i class='fa fa-building fa-fw'></i> Perusahaan <i class='fa fa-angle-right fa-fw'></i> Semua Perusahaan</h5>
			<hr />
...
{
	$tambahan .= nbs(2)."<a href='".site_url('perusahaan/tambah')."' class='btn btn-default' id='TambahPerusahaan'><i class='fa fa-plus fa-fw'></i> Tambah Perusahaan</a>";
...
<script type="text/javascript" language="javascript" >
	$(document).ready(function() {
		var dataTable = $('#my-grid').DataTable( {
			...
			"ajax":{
				url :"<?php echo site_url('perusahaan/perusahaan-json'); ?>",
				type: "post",
	...
	$(document).on('click', '#HapusPerusahaan', function(e){
		e.preventDefault();
	...
	$(document).on('click', '#TambahPerusahaan, #EditPerusahaan', function(e){
		e.preventDefault();
		if($(this).attr('id') == 'TambahPerusahaan')
		{
			$('.modal-dialog').removeClass('modal-sm');
			$('.modal-dialog').addClass('modal-lg');
			$('#ModalHeader').html('Tambah Perusahaan');
		}
		if($(this).attr('id') == 'EditPerusahaan')
		{
			$('.modal-dialog').removeClass('modal-sm');
			$('.modal-dialog').removeClass('modal-lg');
			$('#ModalHeader').html('Edit Perusahaan');
		}
