			...
			<div class='row'>
				<div class='col-sm-3'>
							...
							<div class="form-group">
								...
								<select name='id_toko_resto' id='id_toko_resto' class='form-control input-sm' style='cursor: pointer;'>
									...
									if($nama_resto_toko->num_rows() > 0)
									{
										...
										{
											echo "<option value='".$p->id_merk_barang."'>".$p->merk." (".$p->alamat.") </option>";
										}
									}
									?>
								</select>
						...
						<div class="panel-body">
							...
							<div class="form-horizontal">
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type='text' name='nomor_nota' class='form-control input-sm' id='nomor_nota' value="" <?php echo $readonly; ?> required>
									</div>
								</div>
								<div class="form-group">
					...
					<div class="panel panel-primary" id='PelangganArea'>
						<div class="panel-heading"><i class='fa fa-user'></i> Informasi Pelanggan <?php echo base_url().'assets/img/logo/pertamina_logo.jpg'; ?></div>
						<div class="panel-body">
							<div class="form-group">
