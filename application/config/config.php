...
$config['web_title']		= "Astro Boy";
$config['web_footer']		= $config['web_title']." : <b>Pergunakan Aku Dengan Bijak Dan Tidak Menyalahi Aturan<b><a href='http://sarjanakomedi.com' target='blank'></a>";
