...
class Cetak extends MY_Controller
{
  public function index(){
    ...
    if( ! empty($id_pelanggan))
    {
      ...
      $nama_pelanggan = $this->m_pelanggan->get_baris($id_pelanggan)->row()->nama;
...
$pdf->Output();
          ...
          $pdf->SetMargins(0, -15, 0, 0);
          $pdf->Ln();
          $pdf->Cell(0, 10, 'Pagi Sore Sudirman', 0, 0, 'C');
          $pdf->Ln();
          ...
          $pdf->Output();
}elseif ($nama_toko_resto=="Riverside") {
          ...
          $pdf->SetFont('gadugi','',10.5);
          $pdf->SetMargins(0, -15, 0, 0);
          $pdf->Ln();
          $pdf->Cell(0, 5, 'RIVERSIDE RESTAURANT', 0, 0, 'C');
          $pdf->Ln();
          $pdf->Cell(0, 5, "FEEL THE DIFFERENT ATMOSPHERE", 0, 0, 'C');
          $pdf->Ln();
          $pdf->Ln();
